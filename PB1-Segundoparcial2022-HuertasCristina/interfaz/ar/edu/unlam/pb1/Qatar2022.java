...
public class Qatar2022 {
	...
	private static void mostrarMenu() {
		...
		System.out.println(CALCULAR_PORCENTAJE_DE_COMPLETADO + "- Calcular porcentaje de album completado");
	...
	private static void actualizardatosFigurita(Scanner teclado, Album actual) {
		...
		//teclado.nextLine();//para limpiar el teclado y que entienda que vamos a ingresar otros datos, sino me va a tomar todo parte de la informacion anterior
